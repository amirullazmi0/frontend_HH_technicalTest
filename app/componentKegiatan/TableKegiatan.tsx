            ...
            <div className="shadow-sm overflow-hidden rounded-lg">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="flex gap-2">
                                                    <button className='text-red p-1 rounded shadow-sm active:scale-90 duration-200'>
                ...
                <div className="grid gap-2 p-4 bg-primary">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-blue">{dataKegiatan && dataKegiatan.length > 0 ? `8 jam 50 menit` : '-'}</div>
                    </div>
